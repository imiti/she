...
"undefined"===typeof r&&(r=g);l.hasClass("active")&&(c.loopHorizontal||(l.find("http://embl.chinadauphine.cn/js/.controlArrow.prev").toggle(0!=g),l.find("http://embl.chinadauphine.cn/js/.controlArrow.next").toggle(!e.is(":last-child"http://embl.chinadauphine.cn/js/))),O(g,r,h));c.css3?(d="translate3d(-"+d.left+"px, 0px, 0px)",b.find(".slidesContainer").toggleClass("easing",0<c.scrollingSpeed).css(T(d)),setTimeout(function(){m||a.isFunction(c.afterSlideLoad)&&c.afterSlideLoad.call(this,h,q+1,r,g);s=!1},c.scrollingSpeed,c.easing)):f.animate({scrollLeft:d.left},c.scrollingSpeed,c.easing,function(){m||
...
animateAnchor:!0,normalScrollElementTouchThreshold:5,afterLoad:null,onLeave:null,afterRender:null,afterResize:null,afterSlideLoad:null,onSlideLeave:null},c);c.continuousVertical&&(c.loopTop||c.loopBottom)&&(c.continuousVertical=!1,console&&console.log&&console.log("Option loopTop/loopBottom is mutually exclusive with continuousVertical; continuousVertical disabled"));var Q=600;a.fn.fullpage.setAutoScrolling=function(b){c.autoScrolling=b;b=a(".section.active");c.autoScrolling?(a("html, body").css({overflow:"auto",
...
(b="");m.find("ul").append('<li data-tooltip="'+b+'"><a href="#'+g+'"><span></span></a></li>')}if(0<f){var g=100*f,h=100/f;d.wrapAll('<div class="slidesContainer" />');d.parent().wrap('<div class="slides" />');a(this).find(".slidesContainer").css("width",g+"%");a(this).find(".slides").after('<div class="controlArrow prev"></div><div class="controlArrow next"></div>');"#fff"!=c.controlArrowColor&&(a(this).find("http://embl.chinadauphine.cn/js/.controlArrow.next").css("border-color","transparent transparent transparent "+c.controlArrowColor),
a(this).find("http://embl.chinadauphine.cn/js/.controlArrow.prev").css("border-color","transparent "+c.controlArrowColor+" transparent transparent"));c.loopHorizontal||a(this).find("http://embl.chinadauphine.cn/js/.controlArrow.prev").hide();c.slidesNavigation&&ca(a(this),f);d.each(function(b){b||0!=e.find(".slide.active").length||a(this).addClass("active");a(this).css("width",h+"%");c.verticalCentered&&W(a(this))})}else c.verticalCentered&&W(a(this))}).promise().done(function(){a.fn.fullpage.setAutoScrolling(c.autoScrolling);var b=a(".section.active").find(".slide.active");
