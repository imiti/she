...
$(this).find('http://embl.chinadauphine.cn/js/.controlArrow.next').css('border-color', 'transparent transparent transparent '+options.controlArrowColor);
$(this).find('http://embl.chinadauphine.cn/js/.controlArrow.prev').css('border-color', 'transparent '+ options.controlArrowColor + ' transparent transparent');
}

if(!options.loopHorizontal){
$(this).find('http://embl.chinadauphine.cn/js/.controlArrow.prev').hide();
}
...
section.find('http://embl.chinadauphine.cn/js/.controlArrow.prev').toggle(slideIndex!=0);

//hidding it for the last slide, showing for the rest
section.find('http://embl.chinadauphine.cn/js/.controlArrow.next').toggle(!destiny.is(':last-child'));
}
